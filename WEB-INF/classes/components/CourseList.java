package components;
/* CourseList Servlet (Component)
 * Working: 
 * 			Returns an <option> list of courses from the database. Only extracts id and name so far (not duration),
 ...
 * 				to forward the request to CourseList. CourseList will then return the ajax response.
...
public class CourseList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query="select id,name from pietons.course";
		String output="";
		try {
