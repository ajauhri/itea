...
/**
 * Servlet implementation class TimeTableView
 */
	...
	protected void doPost(HttpServletRequest request,
		...
		request
				.getRequestDispatcher(
						"/components/CLS?user_type=student&firstTime=true&returnType=redirect")
		...
		String query = "select B.class_id, "
				...
				+ "where A.teacher_id = fa.gr_no and A.subject_id = su.id and A.infra_id=in.id "
				+ "group by B.class_id, A.d_id having B.class_id=?";
		PreparedStatement ps = null;
		try {
			ps = conn.prepareStatement(query);
			ps.setInt(1, (Integer) session.getAttribute("class_id"));
