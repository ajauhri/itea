...
<title>ITEA - Dean | Home</title>
<jsp:include page="/components/style.jsp" />
</head>
<body>
<jsp:include page="/components/navbar.jsp" />
<p>
Welcome Dean to the HomePage of <b>I.T.E.A</b>.
</p>
<p>
This will be page your guide to use this software.
</p>
<p>
<b>Messages</b> - This feature will help you to communicate with other users via messages. One
can send messages to individual or even groups of users. Alerts are special type of messages
which are displayed separately since they have a greater privilege.
</p>
<p>
<b>Reports</b> - You can view the strategic and academic reports regarding the college
resources, student and faculty performances and feedback.
</p>
<p>
<b>Declare End of Session</b> - This feature will help you to declare the end of the session which
will promote the students of the college. In order to declare any failures, the dean/hod has to
message to the data manager in order to take iny action.
</p>
<p>
